...
export default function NowPlaying() {
  ...
  return (
    <div className="flex flex-row-reverse max-w-lg p-5 mx-auto mb-8 lg:mx-5 lg:w-full lg:max-w-6xl sm:flex-row">
      <svg className="w-6 h-5 mx-5 mt-1" viewBox="0 0 168 168">
        <path
          fill="#1ED760"
      ...
      <div className="inline-flex flex-col w-full max-w-full truncate sm:flex-row">
        ...
        <p className="text-gray-500 truncate dark:text-gray-300 max-w-max">
          {data?.artist?.slice(0, 25) ?? 'Spotify'}
